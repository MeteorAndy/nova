...
func (s *Server) registerRoutes(h *hertzserver.Hertz) {
	...
	api := h.Group("/api")
	{
		...
		api.POST("/interactive/stories/:id/state-revisions", apiHandlers.HandleInteractiveStateRevisionCreate)
		api.POST("/interactive/stories/:id/state-revisions/:revision_id/undo", apiHandlers.HandleInteractiveStateRevisionUndo)
		api.POST("/interactive/stories/:id/state-revisions/:revision_id/restore", apiHandlers.HandleInteractiveStateRevisionRestore)
		...
		api.GET("/tasks", apiHandlers.HandleTasks)
