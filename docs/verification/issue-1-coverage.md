...
| 32 | Session management full screen | 🟡 | sessions API + UI exist; full-screen flow not browser-tested |
...
| 91 | No submit/switch/migration while offline | 🟡 | natural network failure paths; no explicit gate test |
